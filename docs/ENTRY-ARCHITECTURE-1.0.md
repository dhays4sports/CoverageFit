...
Overall status: BLOCKED. The hosted 408 server-to-server presentation request failed; public Home activation was rolled back and its original journey was verified restored. The direct CoverageFit endpoint works. No claim is made about the upstream root cause without Cloudflare runtime evidence. No remaining route is activated. See ENTRY-READINESS-1.0.md for the checkpoint.
