...
export function decideSignal(conversation,body,options={}) {
 ...
 const questions=[['line','IDENTIFY_LINE','Is this for auto, home, or both?'],['timing','DETECT_TIMING','Is your current policy renewing soon, or are you mainly checking price?'],['current_carrier','DETECT_CARRIER','Who are you currently insured with?'],['current_premium','DETECT_PRICE','About what are you paying now?']];
