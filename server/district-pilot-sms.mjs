...
export async function districtSmsRecord(conversation,env={},store=null){
 if(store&&conversation?.id&&await store.get(CONTROL_PREFIX+conversation.id))return {cohort:'CONTROL'};
 ...
 return rows.length?parse(rows[0].summary_json):null;
}
